...
public class POSFeatureTemplateWSJ extends POSFeatureTemplate
{
	...
	protected void init()
	{
		...
		// 3-gram features
		add(new FeatureItem<>(-2, Field.uncapitalized_simplified_word_form), new FeatureItem<>(-1, Field.uncapitalized_simplified_word_form), new FeatureItem<>(0, Field.uncapitalized_simplified_word_form));
		add(new FeatureItem<>(-2, Field.uncapitalized_simplified_word_form), new FeatureItem<>(-1, Field.uncapitalized_simplified_word_form), new FeatureItem<>(1, Field.uncapitalized_simplified_word_form));
		add(new FeatureItem<>(-1, Field.uncapitalized_simplified_word_form), new FeatureItem<>( 0, Field.uncapitalized_simplified_word_form), new FeatureItem<>(1, Field.uncapitalized_simplified_word_form));
		add(new FeatureItem<>(-1, Field.uncapitalized_simplified_word_form), new FeatureItem<>( 1, Field.uncapitalized_simplified_word_form), new FeatureItem<>(2, Field.uncapitalized_simplified_word_form));
		add(new FeatureItem<>( 0, Field.uncapitalized_simplified_word_form), new FeatureItem<>( 1, Field.uncapitalized_simplified_word_form), new FeatureItem<>(2, Field.uncapitalized_simplified_word_form));
		...
		add(new FeatureItem<>(-1, Field.prefix, 1));
		add(new FeatureItem<>( 0, Field.prefix, 1), new FeatureItem<>(-1, Field.uncapitalized_simplified_word_form));
		add(new FeatureItem<>( 0, Field.suffix, 1), new FeatureItem<>(-1, Field.uncapitalized_simplified_word_form));
		add(new FeatureItem<>( 0, Field.prefix, 1), new FeatureItem<>(+1, Field.uncapitalized_simplified_word_form));
