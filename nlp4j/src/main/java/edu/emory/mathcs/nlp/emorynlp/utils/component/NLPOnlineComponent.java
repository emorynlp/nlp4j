 ...
 */
package edu.emory.mathcs.nlp.emorynlp.utils.component;
...
//	============================== CONSTRUCTORS ==============================
	...
	/** For training. 
	 * @param info TODO*/
	public NLPOnlineComponent(OnlineOptimizer[] optimizers, StringModel[] models, TrainInfo[] info, FeatureTemplate<N,S> template, Eval eval)
	{
		setEval(eval);
		setModels(models);
		setTrainInfo(info);
