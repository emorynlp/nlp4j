...
public class PBLibTest
{
	...
	public void testGetTreeList()
	{
		...
		assertEquals("25-ARG1", aNode.getPredicates().get(0).toString());
		...
		assertEquals("25-rel", aNode.getPredicates().get(0).toString());
		
		aNode = tree.getNode(27, 2);
		assertEquals("25-ARGM-TMP", aNode.getPredicates().get(0).toString());
		...
		assertEquals("21-ARG1", aNode.getPredicates().get(0).toString());
		
		aNode = tree.getNode(22, 2);
		assertEquals("21-ARG2", aNode.getPredicates().get(0).toString());
		
		aNode = tree.getNode(0, 2);
		assertEquals("18-ARG1", aNode.getPredicates().get(0).toString());
		
		aNode = tree.getNode(0, 2);
		assertEquals("21-ARG1", aNode.getPredicates().get(1).toString());
	}
