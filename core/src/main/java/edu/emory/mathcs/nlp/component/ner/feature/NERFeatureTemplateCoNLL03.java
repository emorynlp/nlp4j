 ...
 */
public class NERFeatureTemplateCoNLL03 extends NERFeatureTemplate
{
	private static final long serialVersionUID = -3867869616627234917L;

	public NERFeatureTemplateCoNLL03(int dynamicFeatureSize, int embeddingWindowLeft, int embeddingWindowRight)
	{
	...
	protected void init()
	{
		...
		add(new FeatureItem<>( 1, Field.part_of_speech_tag));
		add(new FeatureItem<>(-1, Field.named_entity_gazetteers));
		add(new FeatureItem<>( 1, Field.named_entity_gazetteers));
