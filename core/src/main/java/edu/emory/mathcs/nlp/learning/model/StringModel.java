...
import edu.emory.mathcs.nlp.learning.instance.StringInstance;
...
//	=================================== SCORES ===================================
	 ...
	 */
	public float[] scores(StringVector x)
	{
		return scores(toSparseVector(x));
	}
	...
	{
		return (labels != null) ? weight_vector.scores(x, labels) : weight_vector.scores(x);
	}
